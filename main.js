    ...
    if (player.radiation) {
        if (player.energy >= 10) {
            if (player.hunger < totalHunger || player.thirst < totalThirst) {
                rnJesus = ((totalThirst - player.thirst) + (totalHunger - player.hunger ) - 3) * shopPrice;
    ...
    if (player.radiation < 1000) {
        if (player.energy >= 100 && player.hunger >= 10 && player.thirst >= 20 && training.charisma == false) {
            ...
            if (rnJesus >= player.charisma) {
                ...
                document.getElementById('historyLog').innerText = "You feel like you could lead a nation. ";
                document.getElementById('historyLog2').innerText = "";

            } else {
                training.statBalance++;

                document.getElementById('historyLog').innerText = "You twisted so many words. You aren't even sure if you spoke a language. ";
                document.getElementById('historyLog2').innerText = "";
            }
            ...
            document.getElementById('historyLog').innerText = "You're too tired to move your mouth. ";
            document.getElementById('historyLog2').innerText = "";
        } 
    } else {
        document.getElementById('historyLog').innerText = 'You are dead. ';
...
function skill7() {
    if (player.radiation < 1000) {
        ...
        if (player.energy >= 10 && player.hunger >= 1 && player.thirst >= 2 && player.scrap >= rnJesus) {
            ...
            if (rnJesus >= player.luck && training.luck === false) {
                player.luck++
                training.luck = true;
            }
...
function saveGame() {
    var saveFile = {
        ...
        changeDay1: dateTracker.changeDay,
    }
...
function loadGame() {
    ...
    dateTracker = loadFile.dateTracker1;
